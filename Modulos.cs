...
{   
    ...
    // =========================================================================================
    // Solicita los datos de un jugador, calcula sus costos y puntos y lo registra en el sistema.

    public static void RegistrarJugador(string? nombre) // metodo caso 1
    {
    ...
    // ============================================================================
    // Muestra el ranking de jugadores ordenado de mayor a menor según sus puntos.

    public static void MostrarRanking() // metodo caso 4
    {
    ...
    // ============================================================================
    // Muestra la información del tercer jugador registrado en el sistema.

    public static void MostrarTercerJugador() // metodo caso 5
    {
